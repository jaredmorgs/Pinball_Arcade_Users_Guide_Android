...
Tap to move the button from the `Top` near the Pause Menu, in 5% increments down the screen. See anchor::Launch_Ball_Position[] for more information about this feature.
Controller Mode::
See anchor:Controller_Configuration[] for more information about controller support.
